    ...
    return (
        <div className="flex flex-col w-[86%] lg:w-[79%] m-auto">
            ...
            <div className="flex flex-row gap-4 lg:gap-2 overflow-x-auto whitespace-nowrap lg:whitespace-normal ">
                ...
                <Image src={js} alt="js" width={500} height={300} className="w-[24%] lg:w-[8.5%] m-auto
                  inline-block py-[8px] px-[26px] border-[1px] border-[#1B1B1B] rounded-md" />

                <Image src={react} alt="react" width={500} height={300} className="w-[24%] lg:w-[8.8%] m-auto
                  inline-block py-[8px] px-[26px] border-[1px] border-[#1B1B1B] rounded-md" />
                
                <Image src={bootstrap} alt="bootstrap" width={500} height={300} className="w-[24%] lg:w-[8.2%] m-auto
                  inline-block py-[8px] px-[26px] border-[1px] border-[#1B1B1B] rounded-md" />
                  ...
                  <Image src={sass} alt="sass" width={500} height={300} className="w-[24%] lg:w-[9.2%] m-auto
                  inline-block py-[8px] px-[26px] border-[1px] border-[#1B1B1B] rounded-md" />
            </div>
          </div>
    )
